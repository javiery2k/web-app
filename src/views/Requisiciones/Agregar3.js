...
class AgregarRequisicion extends Component {
    constructor(props) {
        ...
        this.checkingDynamicInputs = this.checkingDynamicInputs.bind(this);
    ...
    handleValidForm() {
        fetch(`${this.props.appData.endpoint}/requisiciones/`, {
            method: "POST",
            headers: {
            ...
            if (response.status === 'ok') {
                this.props.history.push(`/requisiciones/ver/${response.id}/`);
            }
        });
    }
    checkingDynamicInputs() {
